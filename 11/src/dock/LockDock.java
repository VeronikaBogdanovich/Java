...
public class LockDock implements Dock{
    private int piersCount; // количество причалов
    private int maxWeight; // максимальный вес
    private int currentWeight = 0; // текущий вес
    private int dockedShips = 0; // количество корблей, которые прилчалили
