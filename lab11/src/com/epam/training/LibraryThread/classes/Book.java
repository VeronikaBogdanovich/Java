...
//    static Logger bookLogger = LogManager.getLogger(Book.class.getName());
    ...
    private Queue<com.epam.training.LibraryThread.classes.PeopleReader> lstPeoplesReader = new ConcurrentLinkedQueue<com.epam.training.LibraryThread.classes.PeopleReader>();
...
//                ", byReadyRoom = " + byReadyRoom + ", timeReady = " + timeReady);
    ...
    public Queue<com.epam.training.LibraryThread.classes.PeopleReader> getLstPeoplesReader() {
    ...
    public void addToQueueForReady(com.epam.training.LibraryThread.classes.PeopleReader peopleReader) {
    ...
    public void run() {
        try {
            while (!lstPeoplesReader.isEmpty()) {
                com.epam.training.LibraryThread.classes.PeopleReader peopleReader = lstPeoplesReader.poll();
